...
var MY_SITEINFO = [
	...
	{
		url			: '^http://www\\.kindgirls\\.com/photo/',
		nextLink		: 'id("photo")/div[@class="photo_pag"][last()]/ul/li[last()]/a',
		pageElement	: 'id("photo")',
	},
	{
		url			: '^http://ftop\\.ru/',
		nextLink		: 'id("pagination")//nav//ul[@class="pagination"]/li[@class="active"]/following-sibling::li[position()=1]/a',
		pageElement	: '//div[@class="main-container"]',
	},
];
